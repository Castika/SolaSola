...
from .task_manager import TASKS, update_status, log_to_ui, check_for_cancellation, InterruptedError, update_detailed_status
...
def install_model_wrapper(task_id, repo_id, ui_container_id, sse_manager, client_id, install_lock):
    ...
    try:
        ...
        log_to_ui(task_id, f"Downloading model...", "download")
        ...
        log_to_ui(task_id, "Verifying installation...", "fact_check")
        ...
        log_to_ui(task_id, "Finalizing installation...", "fingerprint")
        ...
        log_to_ui(task_id, "Model installed successfully.", "done", type='success')
        ...
        if model_path_to_cleanup and model_path_to_cleanup.exists():
            ...
            log_to_ui(task_id, "Installation failed. Cleaning up...", "delete", type='error')
        ...
        log_to_ui(task_id, f"An error occurred: {e}", "error", type='error')
