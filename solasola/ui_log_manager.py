...
def log_to_ui(task_id: str, message: str, icon: str, type: str = 'info', target: str = 'both'):
    """
    Appends a user-facing log message to the task's log list.
    This is the centralized function for all UI notifications originating from the backend.
    """
    if task_id in TASKS:
        log_entry = {
            "message": message,
